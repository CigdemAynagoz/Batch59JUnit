...
public class C03_windowHandles {
    ...
    public void test01(){
        ...
        Set<String> windowHanleSeti=driver.getWindowHandles();
        System.out.println(windowHanleSeti);
        ...
        Assert.assertEquals(expectedTitle2,actuelTitle2);

        //● Sayfadaki textin “New Window” olduğunu doğrulayın.
        WebElement ikinciSayfaYaziElmnt= driver.findElement(By.xpath("//h3"));
        String expectedYazi2="New Window";
        String actuelYazi2=ikinciSayfaYaziElmnt.getText();
        Assert.assertEquals(expectedYazi2,actuelYazi2);
