...
public class C02_EnableTest extends TestBase {
    ...
    public void enabledTest() {
        ...
        WebElement istEnableYaziElement = driver.findElement(By.xpath("//p[text=\"It's enabled!\"]"));
        Assert.assertTrue(istEnableYaziElement.isDisplayed());
