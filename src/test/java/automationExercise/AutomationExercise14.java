...
public class AutomationExercise14 {
    ...
    public void test() throws AWTException, InterruptedException {
        ...
        driver.findElement(By.xpath("//input[@placeholder='Name']")).sendKeys("aaaaausernameusera");
        driver.findElement(By.xpath("//input[@data-qa='signup-email']")).sendKeys("aaaaapasspass@wordd.com");
