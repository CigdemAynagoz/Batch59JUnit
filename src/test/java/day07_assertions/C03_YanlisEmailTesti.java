...
public class C03_YanlisEmailTesti {
    ...
    public void test() throws InterruptedException {
        ...
        String istenmeyenEmail="cgdm.ayngz.gmail.com";
        WebElement mailKutusu=driver.findElement(By.xpath("//input[@id='email_create']"));
        mailKutusu.sendKeys("cgdm.ayngz.gmail.com"+Keys.ENTER);

        WebElement uyariYaziElementi=driver.findElement(By.xpath("//*[text()='Invalid email address']"));
        Assert.assertTrue(uyariYaziElementi.isDisplayed());
